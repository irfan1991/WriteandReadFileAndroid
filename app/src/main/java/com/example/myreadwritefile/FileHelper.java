...
public class FileHelper {
    ...
    static void writeToFile(FileModal fileModel, Context context) {
        try {
    ...
    static FileModal readFromFile(Context context, String filename) {
        FileModal fileModel = new FileModal();
        try {
